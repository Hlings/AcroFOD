...
def filter_data(proportion,cur_set,seed=12, cur_pos=1): #seed 代表随机种子  cur_pos 代表当前第几个随机
    random.seed(seed)  
    in_path_txt = '/userhome/yolov5/data/VOC/labels' + '/' + cur_set
    in_path_img = '/userhome/yolov5/data/VOC/images' + '/' + cur_set

    #out_path_img = "/userhome/voc_mini/voc_" + str(proportion) + "/" + "images" + '/' + cur_set
    out_path_img = "/userhome/voc_mini/voc_" + str(proportion) + "/" + "voc_" + str(proportion) +"_" + str(cur_pos) + "/" + "images" + '/' + cur_set
    ...
    out_path_txt = "/userhome/voc_mini/voc_" + str(proportion) + "/" + "voc_" + str(proportion) +"_" + str(cur_pos) + "/" + "labels" + '/' + cur_set
